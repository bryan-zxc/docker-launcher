...
1. Download [`docker-launcher.zip`](https://github.com/bryan-zxc/docker-launcher/releases/download/v0.3.0/docker-launcher.zip) from the latest [GitHub Release](https://github.com/bryan-zxc/docker-launcher/releases)
2. Extract the zip
