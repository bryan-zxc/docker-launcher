...
- Never describe history - ADRs state the current decision, not how we got here. A reader should be able to check compliance against the ADR without landing on content regarding outdated decisions which is important as AI is doing the documentation work.
